...
if ($_SESSION['logged_in'] == true && ($_SESSION['recht'] == "A") || $_SESSION["recht"] == "M") {
	...
	if (isset($_GET['sid'])) {
	    ...
	    if($recht == "M"){
	        $query = "SELECT o.klant, o.id, o.datum, o.totaalprijs, o.afgehandeld, u.department FROM orders o JOIN users u on u.id = o.klant WHERE u.department = '$department' ORDER BY afgehandeld ASC ";
	    }
	    if($recht == "A"){
