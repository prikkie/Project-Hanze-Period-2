...
if ($_SESSION['logged_in'] == true && $_SESSION['recht'] == "A" || ['recht'] == "M") {
	?>
    <h1 align="center">Klachten Overzicht</h1>
    <table border=1>
        <tr>
            <th>Naam</th>
            ...
            <th width="10%">S_email</th>
            <th width="10%">S_telefoon</th>
            <th>Omschrijving</th>
            <th>Wat verwacht</th>
        </tr>
		<?php
		...
		while ($row = mysqli_fetch_assoc($result)) {
			...
			$query1 = "SELECT * FROM products P join supplier S on P.leverancier=S.naam WHERE P.id= '$productNum' ";
