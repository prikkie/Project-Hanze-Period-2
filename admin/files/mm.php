                            ...
                            if (empty($_POST['web'])){
                              ...
                              $query = "INSERT INTO supplier (naam, adres, telefoon, email, website) VALUES ('$naam','$adres','$telefon','$email','$web')";
                                                           ...
                                                           header("Location: http://projecthanze.com/admin/nieuw_supplier");
                                                            ...
                                                            /*  if ($authorisatie=='authorisatie nodig'){?>
                                                                              <td><button type="submit" name="niet" >Nee</button></td>
                                                                               <td><button type="submit" name="yes" >Ja</button></td> <?php }
                                                                           /* <?php if(isset($_POST['niet'])){
                                                                                                             $authorisatie="Afgehandeld";
                                                                                                             $qu="UPDATE orderregels SET toegekend= $authorisatie WHERE order_id =". $sid product =$product";
